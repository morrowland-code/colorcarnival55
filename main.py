...
app.config.update(
    SESSION_COOKIE_SAMESITE="None",  # allow sending cookies via fetch()
    SESSION_COOKIE_SECURE=False,     # set True after HTTPS
    SESSION_COOKIE_HTTPONLY=False,   # allow frontend access if needed
)
# ✅ Make Flask cookies mobile-friendly and secure
app.config.update(
    SESSION_COOKIE_SAMESITE='None',
    SESSION_COOKIE_SECURE=False  # set True if using https later
)
