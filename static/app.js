...
loginButton.addEventListener("click", (e) => {
  ...
  popup.style.zIndex = "999999"; // ensure it's on top of everything
  popup.style.position = "fixed"; // guarantee full-screen overlay
  popup.style.top = "0";
  popup.style.left = "0";
...
// ✅ Fix mobile scroll freeze after closing auth popup
