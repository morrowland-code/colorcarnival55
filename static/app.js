...
function openAuthPopup() {
  ...
  // Make sure popup is visible and scroll works
...
// expose it globally for inline onclick in index.html
...
document.addEventListener("DOMContentLoaded", () => {
 ...
 // 🩷 Show popup on button click (works on mobile too)
// Show popup when clicking (desktop)
loginButton.addEventListener("click", openAuthPopup);
...
// ✅ Restore scrolling after popup closes
